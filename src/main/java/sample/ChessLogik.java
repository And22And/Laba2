...
public class ChessLogik {
    ...
    private static Image pawn = new Image("sample/pawn.png");
    private static Image pawnWhite = new Image("sample/pawnWhite.png");
    private static Image horse = new Image("sample/horse.png");
    private static Image horseWhite = new Image("sample/horseWhite.png");
    private static Image rook = new Image("sample/rook.png");
    private static Image rookWhite = new Image("sample/rookWhite.png");
    private static Image bis = new Image("sample/bis.png");
    private static Image bisWhite = new Image("sample/bisWhite.png");
    private static Image king = new Image("sample/king.png");
    private static Image kingWhite = new Image("sample/kingWhite.png");
    private static Image queen = new Image("sample/queen.png");
    private static Image queenWhite = new Image("sample/queenWhite.png");
